 ...
 * AMapV1地图中简单介绍GPS定位
 */
public class LocationGPSActivity extends Activity implements AMapLocationListener {
    ...
    private void init() {
        ...
        locationManager = LocationManagerProxy.getInstance(LocationGPSActivity.this);
