 ...
 */
public class PoiAroundSearchActivity extends FragmentActivity implements OnMarkerClickListener, InfoWindowAdapter,
        OnItemSelectedListener, OnPoiSearchListener, OnMapClickListener, OnInfoWindowClickListener, OnClickListener {
    private AMap aMap;
    ...
    private void init() {
        if (aMap == null) {
            ...
            locationMarker = aMap.addMarker(new MarkerOptions().anchor(0.5f, 1)
                    ...
                    .position(new LatLng(lp.getLatitude(), lp.getLongitude())).title("西单为中心点，查其周边"));
    ...
    private void setUpMap() {
        ...
        ArrayAdapter<String> adapter = new ArrayAdapter<String>(this, android.R.layout.simple_spinner_item, itemDeep);
    ...
    private void setSelectType() {
        ...
        ArrayAdapter<String> adapter = new ArrayAdapter<String>(this, android.R.layout.simple_spinner_item, itemTypes);
        adapter.setDropDownViewResource(android.R.layout.simple_spinner_dropdown_item);
    ...
    protected void doSearchQuery() {
        ...
        if (lp != null) {
             ...
             * list.add(AMapUtil.convertToLatLonPoint(Constants.BEIJING)); poiSearch.setBound(new SearchBound(list));//
             * 设置多边形poi搜索范围
             */
            ...
            if (result != null) {// 搜索poi的结果
                if (detailMarker != null) {
                    ...
                    if (result.getDeepType() != null) {
                        ...
                        ToastUtil.show(PoiAroundSearchActivity.this, "此Poi点没有深度信息");
                    }
                }
    ...
    public void onMapClick(LatLng latng) {
        locationMarker = aMap.addMarker(new MarkerOptions().anchor(0.5f, 1)
                .icon(BitmapDescriptorFactory.fromResource(R.drawable.point)).position(latng).title("点击选择为中心点"));
        locationMarker.showInfoWindow();
    }
