...
import com.taobao.tae.sdk.demo.amap.utils.Constants;

/**
 * AMapV2地图中介绍如何显示一个基本地图
 */
public class AMap3DMapActivity extends Activity implements OnClickListener, CancelableCallback {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_3dmap);
        /*
    ...
    private void setUpMap() {
        ...
        aMap.addMarker(new MarkerOptions().perspective(true).position(Constants.FANGHENG)
    ...
    public void onClick(View v) {
        ...
        case R.id.Zhongguancun:
            changeCamera(CameraUpdateFactory.newCameraPosition(new CameraPosition(Constants.ZHONGGUANCUN, 18, 0, 30)),
                    null);
            break;
         ...
         */
        case R.id.Lujiazui:
            changeCamera(CameraUpdateFactory.newCameraPosition(new CameraPosition(Constants.SHANGHAI, 18, 30, 0)), this);
            break;
        /**
    ...
    public void onCancel() {
        Toast.makeText(AMap3DMapActivity.this, "Animation to 陆家嘴 canceled", Toast.LENGTH_LONG).show();
    }
    ...
    public void onFinish() {
        Toast.makeText(AMap3DMapActivity.this, "Animation to 陆家嘴 complete", Toast.LENGTH_LONG).show();
    }
}
